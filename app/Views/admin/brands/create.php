        ...
        <form class="needs-validation" novalidate method="POST" action="/admin/brands/store">
          <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                  <input type="text" class="form-control" id="brandname" placeholder="brand name" required name="name">
          ...
          <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                  <input type="text" class="form-control" id="branddescription" placeholder="brand description" required name="description">
                  <div class="invalid-feedback">
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Create new brand</button>
        </form>
      </div>
    </div>
  </main>
