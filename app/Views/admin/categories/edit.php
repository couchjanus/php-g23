      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate method="POST" action="">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="categoryname" value="<?=$category->name?>" required name="name">
          ...
          <div class="form-check">
            <input type="checkbox" name="status" class="form-check-input" id="status" <?php echo ($category->status==1)?"checked":""?>>
